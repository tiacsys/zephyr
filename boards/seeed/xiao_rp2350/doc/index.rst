...
test pads on bottom side of the PCB, the default pin mapping is the following:

.. figure:: img/xiao_rp2350_pinout_header.webp
   :align: center
   :alt: XIAO RP2350 Pinout (header)

   XIAO RP2350 Pinout (header)

.. figure:: img/xiao_rp2350_pinout_pads.webp
   :align: center
   :alt: XIAO RP2350 Pinout (test pads)

   XIAO RP2350 Pinout (test pads)
...
.. _`Seeed Studio XIAO RP2350`: https://wiki.seeedstudio.com/getting-started-xiao-rp2350
