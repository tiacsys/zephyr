...
Zephyr supports a couple of different MikroElektronika Click shields carrying
the Microchip `External CAN FD Controllers`_, either with or without integrated
...
Set ``--shield mikroe_mcp2517fd_click`` when you invoke ``west build``,
for example:
