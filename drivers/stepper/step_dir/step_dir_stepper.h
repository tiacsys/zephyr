 ...
 */
typedef int (*step_dir_stepper_init)(const struct device *dev);
 ...
 */
typedef int (*step_dir_stepper_move_by)(const struct device *dev, const int32_t micro_steps);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_move_to)(const struct device *dev, const int32_t value);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_set_microstep_interval)(const struct device *dev,
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_set_reference_position)(const struct device *dev,
						       const int32_t value);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_get_actual_position)(const struct device *dev, int32_t *value);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_is_moving)(const struct device *dev, bool *is_moving);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_run)(const struct device *dev,
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_stop)(const struct device *dev);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
typedef int (*step_dir_stepper_set_event_callback)(const struct device *dev,
 ...
 * @param dev Pointer to the device structure.
 */
typedef void (*step_dir_stepper_handle_timing_signal)(const struct device *dev);
 ...
 */
typedef void (*step_dir_stepper_trigger_callback)(const struct device *dev,
...
struct step_dir_stepper_api {
	step_dir_stepper_init init;
	step_dir_stepper_move_by move_by;
	step_dir_stepper_move_to move_to;
	step_dir_stepper_set_microstep_interval set_microstep_interval;
	step_dir_stepper_set_reference_position set_reference_position;
	step_dir_stepper_get_actual_position get_actual_position;
	step_dir_stepper_is_moving is_moving;
	step_dir_stepper_run run;
	step_dir_stepper_stop stop;
	step_dir_stepper_set_event_callback set_event_callback;
	step_dir_stepper_handle_timing_signal handle_timing_signal;
	step_dir_stepper_trigger_callback trigger_callback;
};
