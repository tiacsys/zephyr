...
ZTEST_F(counter, test_no_value_change_after_stop)
{
...
ZTEST_F(counter, test_value_increase_over_time)
{
	uint32_t value_1 = 0;
	uint32_t value_2 = 0;
	(void)counter_start(fixture->pit_channel_1);
...
ZTEST_F(counter, test_set_top_value)
{
...
ZTEST_F(counter, test_counter_wraps)
{
	uint32_t value_1 = 0;
	uint32_t value_2 = 0;
...
ZTEST_F(counter, test_top_value_zero_ticks)
{
...
ZTEST_F(counter, test_top_value_interrupt_set)
{
...
ZTEST_F(counter, test_top_value_interrupt_unset)
{
	int32_t freq = counter_get_frequency(fixture->pit_channel_1);
	int data = 0;
...
ZTEST_F(counter, test_top_value_no_counter_value_reset)
{
...
ZTEST_F(counter, test_top_value_no_value_reset_new_top_value_smaller_than_counter_value)
{
	counter_start(fixture->pit_channel_1);
...
ZTEST_F(counter, test_two_pit_channels_top_interrupts)
{
	int32_t freq = counter_get_frequency(fixture->pit_channel_1);
	int data_1 = 0;
	int data_2 = 0;
