...
ZTEST_F(drv8424_api, test_set_target_position_positive_direction_movement)
{
	int32_t pos = 50;
...
ZTEST_F(drv8424_api, test_set_target_position_negative_direction_movement)
{
	int32_t pos = -50;
...
ZTEST_F(drv8424_api, test_set_target_position_identical_current_and_target_position)
{
	int32_t pos = 0;
...
ZTEST_F(drv8424_api, test_set_target_position_zero_velocity)
{
	int32_t pos = 100;
	int32_t ret = 0;
...
ZTEST_F(drv8424_api, test_set_target_position_is_moving_true_while_moving)
{
	int32_t pos = 50;
	bool moving = false;
...
ZTEST_F(drv8424_api, test_set_target_position_is_moving_false_when_completed)
{
	int32_t pos = 50;
	bool moving = false;
...
ZTEST_F(drv8424_api, test_set_target_position_no_movement_when_disabled)
{
	int32_t pos = 50;
	int32_t curr_pos = 50;
	int32_t ret = 0;
...
ZTEST_F(drv8424_api, test_move_positive_step_count)
{
	int32_t steps = 50;
...
ZTEST_F(drv8424_api, test_move_negative_step_count)
{
	int32_t steps = -50;
...
ZTEST_F(drv8424_api, test_move_zero_steps_no_movement)
{
	int32_t steps = 0;
...
ZTEST_F(drv8424_api, test_move_zero_velocity)
{
	int32_t steps = 100;
	int32_t ret = 0;
	int32_t pos = 100;
...
ZTEST_F(drv8424_api, test_move_is_moving_true_while_moving)
{
	int32_t steps = 50;
	bool moving = false;
...
ZTEST_F(drv8424_api, test_move_is_moving_false_when_completed)
{
	int32_t steps = 50;
	bool moving = true;
...
ZTEST_F(drv8424_api, test_move_no_movement_when_disabled)
{
	int32_t steps = 100;
